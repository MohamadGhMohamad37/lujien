                ...
                <div class="wrapper">
                    <div class="detail-block__content">
                        ...
                        <ul class="bread-crumbs">
                            ...
                            <li class="bread-crumbs__item">FAQ</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="faq">
                <div class="wrapper">
                    <div class="faq-search">
                        <form>
                            <div class="box-field__row box-field__row-search">
								<div class="box-field">
									<input type="search" class="form-control" placeholder="Search">
								</div>
								<button type="submit" class="btn btn-icon"> <i class="icon-search"></i> search</button>
							</div>
                        </form>
                    </div>
                    <div class="faq-items">
                        ...
                        <div class="faq-item">
                            <div class="faq-item__head">
                                <span class="faq-item__head-num">3</span>
                        ...
                        <div class="faq-item">
                            <div class="faq-item__head">
                                <span class="faq-item__head-num">4</span>
                        ...
                        <div class="faq-item">
                            <div class="faq-item__head">
                                <span class="faq-item__head-num">5</span>
                                Why are animal fats in cosmetics?
                                <span class="faq-item__head-btn"></span>
                            </div>
                            <div class="faq-item__content">
                                <p>Velit sit et dolore consequat ex elit ea. Proident duis nostrud id id. In sint commodo sint adipisicing ullamco magna voluptate voluptate nostrud reprehenderit magna veniam in. Consectetur exercitation proident aliqua duis nulla labore. Culpa proident qui ullamco id velit. Est anim est non qui veniam adipisicing non adipisicing deserunt incididunt laborum do esse do.Amet ipsum quis ipsum proident est elit proident qui in. Nulla mollit nostrud consectetur eiusmod occaecat incididunt excepteur occaecat velit. Non ipsum nostrud dolore est ut irure tempor ea velit id sit. Laboris Lorem ipsum et reprehenderit mollit ex aute officia sint et. Occaecat est occaecat commodo ea sunt pariatur.</p>
                        ...
                        <div class="faq-item">
                            <div class="faq-item__head">
                                <span class="faq-item__head-num">6</span>
                        ...
                        <div class="faq-item">
                            <div class="faq-item__head">
                                <span class="faq-item__head-num">7</span>
                        ...
                        <div class="faq-item">
                            <div class="faq-item__head">
                                <span class="faq-item__head-num">8</span>
                        ...
                        <div class="faq-item">
                            <div class="faq-item__head">
                                <span class="faq-item__head-num">9</span>
                                Is it true that there is no cosmetics without preservatives?
                                <span class="faq-item__head-btn"></span>
                            </div>
                            <div class="faq-item__content">
                                <p>Velit sit et dolore consequat ex elit ea. Proident duis nostrud id id. In sint commodo sint adipisicing ullamco magna voluptate voluptate nostrud reprehenderit magna veniam in. Consectetur exercitation proident aliqua duis nulla labore. Culpa proident qui ullamco id velit. Est anim est non qui veniam adipisicing non adipisicing deserunt incididunt laborum do esse do.Amet ipsum quis ipsum proident est elit proident qui in. Nulla mollit nostrud consectetur eiusmod occaecat incididunt excepteur occaecat velit. Non ipsum nostrud dolore est ut irure tempor ea velit id sit. Laboris Lorem ipsum et reprehenderit mollit ex aute officia sint et. Occaecat est occaecat commodo ea sunt pariatur.</p>
                    ...
                    <div class="faq-more">
                        <a href="#">show more <i class="icon-arrow-md"></i></a>
                    </div>
                </div>
