            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('abouts.update', ['lang' => app()->getLocale(), 'about' => $about->id]) }}"
                            ...
                            @foreach (['en', 'ar'] as $lang)
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name_{{ $lang }}"
                                        id="name_{{ $lang }}"
                                        value="{{ old('name_' . $lang, $about->{'name_' . $lang}) }}">
                                    @error('name_' . $lang)
                            ...
                            @foreach (['en', 'ar'] as $lang)
                                <div class="form-group">
                                    <label for="description_{{ $lang }}">{{ __('messages.description') }}
                                        ({{ strtoupper($lang) }}):</label>
                                    <textarea class="form-control" name="desc_{{ $lang }}" id="desc_{{ $lang }}">{!! old('desc_' . $lang, $about->{'desc_' . $lang}) !!}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div id="drop-area" class="drop-area">
                                    ...
                                    <input type="file" name="image" id="image" class="form-control"
                                        style="display: none;">
                                    @if ($about->image)
                                        <img id="image-preview" src="{{ asset($about->image) }}" alt="Image Preview"
                            ...
                            <button type="submit" class="btn btn-primary mr-2">
                                <i class="fas fa-edit"></i> {{ __('messages.update_about') }}
                            </button>
                        </form>
                    </div>
                </div>
