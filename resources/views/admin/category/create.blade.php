...
@section('title', __('pages.create_categories'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="header-title">{{ __('pages.create_categories') }}</h4>

                    <form action="{{ route('categories.store', ['lang' => $lang]) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="desc_en" name="desc_en" class="form-control tinymce-editor">{{ old('desc_en') }}</textarea>
                            @error('desc_en')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="desc_ar" name="desc_ar" class="form-control tinymce-editor">{{ old('desc_ar') }}</textarea>
                            @error('desc_ar')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
